...
<form action="<?php echo site_url() . "/GeneratePDF/gen_pdf/"; ?>" method="post">
    

    <button type="submit" name="Send_mail" value="Send_email" class="btn btn-default">Generate PDF</button>
</form>
<!--form----------------------------------------------------------------------------------------------------------------------------------------->
